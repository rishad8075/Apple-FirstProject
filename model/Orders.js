...
const OrdersSchema = new Schema({
  ...
  status: { type: String, enum:  ["PaymentFailed","Ordered", "Pending", "Confirmed", "Shipped", "Out for Delivery", "Delivered", "Cancelled", "Returned","Return Requested"], default: 'Pending' },
  orderItems: [{
